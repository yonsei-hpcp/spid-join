...
typedef struct rotate_n_stream_job_t
{
    ...
    int rank_ids_for_multi_rank_copy[NUM_MAX_RANKS];
...
#define DPU_TRANSFER_JOB_TYPE_CHIPWISE_BROADCAST_BG8 18
#define DPU_TRANSFER_JOB_TYPE_CHIPWISE_BROADCAST_BG16 19
#define DPU_TRANSFER_JOB_TYPE_CHIPWISE_BROADCAST_BG32 20
#define DPU_TRANSFER_JOB_TYPE_CHIPWISE_BROADCAST_BG64 21
